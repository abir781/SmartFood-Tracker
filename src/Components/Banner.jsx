...
const Banner = () => {
    ...
    >
      <SwiperSlide className='text-white'>
        <img className='h-[70vh] relative rounded-2xl' src="/slider1.jpg" alt="" style={{width:"100%"}} />
      ...
      <SwiperSlide className='text-white'>
        <img className='h-[70vh] relative rounded-2xl' src="/slider2.jpg" alt="" style={{width:"100%"}}/>
      ...
      <SwiperSlide className='text-white'>
        <img className='h-[70vh] relative rounded-2xl' src="/slider3.jpg" alt="" style={{width:"100%"}}/>
